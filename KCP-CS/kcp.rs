//! Genshin KCP
//! Written by skywind3000, ported by Matrix-Zhang and modified by PartyPooper.
...
macro_rules! debug_kcp {
    ($self:ident) => {
        /* info!("debug: current={}", $self.current); */
    };
}
